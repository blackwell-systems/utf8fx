    ...
    fn expand_native(
        ...
        match component {
            ...
            "sparkline" => {
                ...
                let stroke_color = params.get("stroke").map(|c| self.resolve_color(c));
                ...
                let track_color = params.get("track").map(|c| self.resolve_color(c));
            ...
            "rating" => {
                ...
                let fill_color = params
                    .get("fill")
                    .map(|c| self.resolve_color(c))
                    .unwrap_or_else(|| self.resolve_color("warning")); // gold/yellow default
